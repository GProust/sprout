...
import com.gproust.sprout.ui.medicines.MedicinesViewModel
...
import com.gproust.sprout.ui.report.ReportViewModel
...
class SproutViewModelFactory(
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>, extras: CreationExtras): T {
        return when {
            ...
            modelClass.isAssignableFrom(ReportViewModel::class.java) -> ReportViewModel(repository, context)
            ...
            modelClass.isAssignableFrom(MedicinesViewModel::class.java) -> MedicinesViewModel(repository, context)
